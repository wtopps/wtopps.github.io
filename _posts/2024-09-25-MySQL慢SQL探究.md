...
![mysql执行过程](/assets/images/cd8a41908bfb440f839ff4af1b58e49d.png)
...
![SQL分析三步走](/assets/images/b3f6e845c2494fd9bdcaa7141f2758d3.png)
...
让我们一起来看一下`profile`分析如何使用，我们先执行下面的SQL：
...
![profile执行耗时详情](/assets/images/15dbb62df5fe4b958dce9d0f866d2f9e.png)
...
在客户端执行一个`EXPLAIN`语句，生成一个执行计划，然后在`information_chema.optimizer_trace`的表里面查找这一条语句对应的信息：
...
`trx_commit` 和 `sync_binlog` 这两个参数也放进来的原因是不同的参数组合对 IO 的压力也会有区别。
